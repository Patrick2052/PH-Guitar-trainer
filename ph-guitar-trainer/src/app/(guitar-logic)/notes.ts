...
export class Note {
    ...
    constructor(note: NoteEnum, color: string, isNatural: boolean, uuid: string) {
        this.note = note;
        this.color = color;
        this.uuid = uuid;
    ...
    getMajorScale(): Note[] {
        ...
        scale.push(this.wholeStepUp().wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp());
        scale.push(this.wholeStepUp().wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp().wholeStepUp());
        scale.push(this.wholeStepUp().wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp().wholeStepUp().halfStepUp());
    ...
    getMinorAoleanScale(): Note[] {
        ...
        scale.push(this.wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp().halfStepUp());
        scale.push(this.wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp().halfStepUp().wholeStepUp());
        scale.push(this.wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp().halfStepUp().wholeStepUp().wholeStepUp());
